    ...
    <body>
        ...
        <div class="contenido">
            ...
            <div class="alert alert-danger" role="alert">
                ¿Confirma que desea eliminar al siguiente producto?
            </div>

            <form action="eliminar_bd.php" >
                ...
                <input type="number" name="cantidad" min="1" max="300"
                       ...
                       readonly="" value="<?php echo $cantidad; ?>" />
                ...
                <input type="number" name="precio_venta" step=0.01 min="1" max="300"
                       ...
                       title="Deben ser entre 1 y 300." required="required"
                       readonly="" value="<?php echo $precio_venta; ?>" />
